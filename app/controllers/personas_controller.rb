class PersonasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @persona.save
        format.html { redirect_to persona_url(@persona), notice: "Persona creada." }
  ...
  def update
    respond_to do |format|
      if @persona.update(persona_params)
        format.html { redirect_to persona_url(@persona), notice: "Persona modificada." }
  ...
  private
    ...
    def persona_params
      params.require(:persona).permit(:nombre, :apellido, :nacimiento, :dni)
    end
end
